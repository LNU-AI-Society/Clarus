...
const ChatPage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[linear-gradient(135deg,_#f7f2ed_0%,_#fbf7f2_45%,_#eef6f3_100%)] text-[#1f2937]">
      <div className="pointer-events-none absolute -top-[240px] -left-[200px] h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle_at_center,_rgba(255,231,214,0.9),_transparent_70%)] opacity-70 blur-[0.5px]" />
      <div className="pointer-events-none absolute -right-[220px] -bottom-[260px] h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle_at_center,_rgba(221,244,241,0.8),_transparent_70%)] opacity-70 blur-[0.5px]" />
      <div className="relative z-10 flex h-screen flex-col overflow-hidden">
        ...
        <main className={`flex min-h-0 flex-1 flex-col ${isEmpty ? 'pb-72' : 'pt-16 pb-52'}`}>
          {isEmpty ? (
